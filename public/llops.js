  ...
  function render() {
    ...
    if (S.view === 'prov') {
      ...
      for (const m of list) {
        ...
        const shCell = !isSub
          ? '<span class="llonly" data-key="' + esc(key) + '" title="该商家未订阅。点此：订阅该商家并只上架这一个模型，其余保持下架" style="cursor:pointer;color:#e3b341;font-weight:600;font-size:11px;text-decoration:underline dotted">＋只上架此</span>'
